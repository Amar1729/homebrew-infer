class InferAT0150 < Formula
  ...
  def caveats; <<~EOS
    Version 0.15.0 of infer is purely kept for those running outdated macOS (Sierra, High Sierra, or El Capitan).

    It is highly recommended to upgrade to Mojave or newer, where infer >= 0.17.0 is provided by this tap.
  EOS
  end
